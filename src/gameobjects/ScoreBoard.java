...
public class ScoreBoard extends VBox {
	...
	private void createLabels() {
		bankLabel.setFont(Font.font("Georgia", 18));
		bankLabel.setTextFill(Color.WHITE);
		bankLabel.setAlignment(Pos.CENTER_LEFT);
		bankLabel.setPadding((new Insets(5, 10, 5, 10)));

		bankAmount.setFont(Font.font("Georgia", 18));
		bankAmount.setTextFill(Color.WHITE);
		bankAmount.setAlignment(Pos.CENTER_RIGHT);
		bankAmount.setPadding((new Insets(5, 10, 5, 10)));

		winAmountLabel.setFont(Font.font("Georgia", 18));
		winAmountLabel.setTextFill(Color.WHITE);
		winAmountLabel.setAlignment(Pos.CENTER_LEFT);
		winAmountLabel.setPadding((new Insets(2, 10, 2, 10)));

		winAmount.setFont(Font.font("Georgia", 18));
		winAmount.setTextFill(Color.WHITE);
