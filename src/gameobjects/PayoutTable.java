...
public class PayoutTable extends VBox {
	...
	public void setTextColors(Color color) {
		for(int i = 0; i < textList.length; i++) {
			textList[i].setTextFill(color);
			multiplierList[i].setTextFill(color);
			oddsBaseList[i].setTextFill(color);
			oddsTo[i].setTextFill(color);
		}
	}
	...
	private void setBonusData() {
		...
		case "drawpoker":
		case "poker":
			String[] drawnames = { "Jacks or Better", "2 Pair", "3 of a Kind", "Straight", "Flush", "Full House",
					"4 of a Kind", "Straight Flush", "Royal Flush" };

			bonusNames = drawnames;
			int[][] drawodds = { { 1, 1 }, // pair Jacks or better
					{ 2, 1 }, // 2 pair
					{ 4, 1 }, // 3 of a kind
					{ 7, 1 }, // straight
					{ 9, 1 }, // flush
			...
			break;
		case "deuceswild":
			String[] wildnames = { "Jacks or Better", "2 Pair", "3 of a Kind", "Straight", "Flush", "Full House",
					"4 of a Kind", "Straight Flush", "5 of a Kind", "Wild Royal Flush", "4 Deuces", "Royal Flush" };

			bonusNames = wildnames;
			int[][] wildodds = { { 1, 1 }, // pair Jacks or better
					{ 2, 1 }, // 2 pair
					{ 4, 1 }, // 3 of a kind
					{ 7, 1 }, // straight
					{ 9, 1 }, // flush
			...
			break;
		case "tioli":
			String[] tiolinames = { "2 Pair Aces High", "3 of a Kind", "Straight", "Flush", "Full House", "4 of a Kind",
					"Straight Flush", "Royal Flush" };

			bonusNames = tiolinames;
			int[][] tioliodds = { { 2, 1 }, // 2 pair
					{ 4, 1 }, // 3 of a kind
					{ 7, 1 }, // straight
					{ 9, 1 }, // flush
					{ 15, 1 }, // full house
		...
		default:
			String[] defaultnames = { "Jacks or Better", "2 Pair", "3 of a Kind", "Straight", "Flush", "Full House",
					"4 of a Kind", "Straight Flush", "Royal Flush" };

			bonusNames = defaultnames;
			int[][] defaultodds = { { 1, 1 }, // pair Jacks or better
					{ 2, 1 }, // 2 pair
					{ 4, 1 }, // 3 of a kind
					{ 7, 1 }, // straight
					{ 9, 1 }, // flush
	...
	private void createLabels() {
		for (int i = 0; i < textList.length; i++) {
			...
			textList[i].setFont(Font.font("Georgia", 18));
			...
			multiplierList[i].setFont(Font.font("Georgia", 18));
			...
			oddsTo[i].setFont(Font.font("Georgia", 18));
